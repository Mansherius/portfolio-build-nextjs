...
export const BentoGrid = ({
  ...
  return (
    <div
      className={cn(
        "grid grid-cols-1 md:grid-cols-6 lg:grid-cols-5 md:grid-row-7 gap-4 lg:gap-8 mx-auto p-12",
        className
      )}
    >
      {children}
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: 'linear-gradient(153deg, rgba(4,9,30,1) 29%, rgba(18,10,84,1) 67%)',
      }}
    >
